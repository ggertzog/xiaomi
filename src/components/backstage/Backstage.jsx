      ...
      <div className={styles.container}>
        ...
        <div className={styles.description}>
          ...
          <p className={styles.text}>
            ...
            и&nbsp;фотокампейн, отправившись на Северный Кавказ, к&nbsp;подножию Эльбруса,
            через водопады и&nbsp;мистические заброшенные усадьбы. Весь фото- и&nbsp;видеоконтент
            созданы с&nbsp;помощью Mi&nbsp;10T Pro.
          </p>
        </div>

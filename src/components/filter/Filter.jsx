      ...
      <div className={styles.container}>
        <div className={styles.box}>
          ...
          <div className={styles.buttonContainer}>
            <button className={styles.button}>cyberpunk</button>
            <button className={styles.button}>color focus</button>
            <button className={styles.button}>gold vibes</button>
            <button className={styles.button}>black ice</button>
          </div>
        </div>
